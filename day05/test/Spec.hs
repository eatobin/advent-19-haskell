...
main = hspec $ do
  ...
  let intCode = IntCode {input = 0, output = 0, pointer = 0, memory = thisMemory}
  ...
  describe "\nrunOpCode Tests" $ do
    it "aocMemory1Test" $
      do
        runOpCode (IntCode {input = 0, output = 0, pointer = 0, memory = makeMemory aocMemory1})
        `shouldBe` IntCode {input = 0, output = 0, pointer = 4, memory = Map.fromList [(0, 1), (1, 0), (2, 0), (3, 2), (4, 99)]}
    it "aocMemory2Test" $
      do
        runOpCode (IntCode {input = 0, output = 0, pointer = 0, memory = makeMemory aocMemory2})
        `shouldBe` IntCode {input = 0, output = 0, pointer = 8, memory = Map.fromList [(0, 3500), (1, 9), (2, 10), (3, 70), (4, 2), (5, 3), (6, 11), (7, 0), (8, 99), (9, 30), (10, 40), (11, 50)]}
    it "aocMemory3Test" $
      do
        runOpCode (IntCode {input = 0, output = 0, pointer = 0, memory = makeMemory aocMemory3})
        `shouldBe` IntCode {input = 0, output = 0, pointer = 4, memory = Map.fromList [(0, 2), (1, 0), (2, 0), (3, 0), (4, 99)]}
    it "aocMemory4Test" $
      do
        runOpCode (IntCode {input = 0, output = 0, pointer = 0, memory = makeMemory aocMemory4})
        `shouldBe` IntCode {input = 0, output = 0, pointer = 4, memory = Map.fromList [(0, 2), (1, 3), (2, 0), (3, 6), (4, 99)]}
    it "aocMemory5Test" $
      do
        runOpCode (IntCode {input = 0, output = 0, pointer = 0, memory = makeMemory aocMemory5})
        `shouldBe` IntCode {input = 0, output = 0, pointer = 4, memory = Map.fromList [(0, 2), (1, 4), (2, 4), (3, 5), (4, 99), (5, 9801)]}
    it "aocMemory6Test" $
      do
        runOpCode (IntCode {input = 0, output = 0, pointer = 0, memory = makeMemory aocMemory6})
  ...
  describe "\njump Tests" $ do
    ...
    describe "\nlargeEights Tests" $ do
      it "lessThanEight" $
        do
          runOpCode (IntCode {pointer = 0, output = 0, memory = makeMemory largeEight, input = 7})
          `shouldBe` IntCode {input = 7, output = 999, pointer = 46, memory = Map.fromList [(0, 3), (1, 21), (2, 1008), (3, 21), (4, 8), (5, 20), (6, 1005), (7, 20), (8, 22), (9, 107), (10, 8), (11, 21), (12, 20), (13, 1006), (14, 20), (15, 31), (16, 1106), (17, 0), (18, 36), (19, 98), (20, 0), (21, 7), (22, 1002), (23, 21), (24, 125), (25, 20), (26, 4), (27, 20), (28, 1105), (29, 1), (30, 46), (31, 104), (32, 999), (33, 1105), (34, 1), (35, 46), (36, 1101), (37, 1000), (38, 1), (39, 20), (40, 4), (41, 20), (42, 1105), (43, 1), (44, 46), (45, 98), (46, 99)]}
      it "equalEight" $
        do
          runOpCode (IntCode {pointer = 0, output = 0, memory = makeMemory largeEight, input = 8})
          `shouldBe` IntCode {input = 8, output = 1000, pointer = 46, memory = Map.fromList [(0, 3), (1, 21), (2, 1008), (3, 21), (4, 8), (5, 20), (6, 1005), (7, 20), (8, 22), (9, 107), (10, 8), (11, 21), (12, 20), (13, 1006), (14, 20), (15, 31), (16, 1106), (17, 0), (18, 36), (19, 98), (20, 1000), (21, 8), (22, 1002), (23, 21), (24, 125), (25, 20), (26, 4), (27, 20), (28, 1105), (29, 1), (30, 46), (31, 104), (32, 999), (33, 1105), (34, 1), (35, 46), (36, 1101), (37, 1000), (38, 1), (39, 20), (40, 4), (41, 20), (42, 1105), (43, 1), (44, 46), (45, 98), (46, 99)]}
      it "greaterThanEight" $
        do
          runOpCode (IntCode {pointer = 0, output = 0, memory = makeMemory largeEight, input = 9})
