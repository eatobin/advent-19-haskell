...
lookupResult :: IntCodeStruct -> PointerOffset -> Maybe KeyOrValue
lookupResult intcode pointerOffsetParam = Map.lookup (pointer intcode + pointerOffsetParam) (memory intcode)
