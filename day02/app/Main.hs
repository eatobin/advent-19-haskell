...
import Lib (IntCodeState (..), makeMemory, runOpCode, updatedMemory)
...
main =
  do
    ...
    let answer1 = memory (runOpCode IntCodeState {pointer = 0, memory = updatedMemory 12 2 firstMemory}) Vec.! 0
