...
main =
  do
    ...
    let answer1 = memory (runOpCode IntCodeStruct {pointer = 0, memory = updatedMemory 12 2 firstMemory}) Vec.! 0
    ...
    let answer2 =
          head
            [ (100 * noun) + verb
              | noun <- [0 .. (99 :: Int)],
                verb <- [0 .. (99 :: Int)],
                let candidate = memory (runOpCode IntCodeStruct {pointer = 0, memory = updatedMemory noun verb firstMemory}) Vec.! 0,
                candidate == 19690720
            ]
